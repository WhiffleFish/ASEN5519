...
## Simply run all cells in FinalResultsDemo.ipynb to test
...
- Get Bug1 Path Data : ``` path, dist = BUG1(qstart, qgoal, W)```
- Get Bug2 Path Data : ``` path, dist = BUG2(qstart, qgoal, W)```
